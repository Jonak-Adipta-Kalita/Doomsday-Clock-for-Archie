...
const Clock = ({
	...
	const update = useCallback((key: keyof TimeState, op: "+" | "-") => {
		setTime((prev) => {
			if (!prev) return prev;
			...
			<div className="mt-10 md:text-4xl text-2xl px-5 text-center">
				<p>
					...
					<span className="text-gray-200">
						: &ldquo;{loadData?.message}&rdquo;
					</span>
				</p>
			</div>

			<button
				className="mt-5 button bg-teal-500/20 drop-shadow-transparent shadow-transparent"
